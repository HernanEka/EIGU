                                    ...
                                    <div class="input-group">
                                        ...
                                        <datalist id="User">
                                            @foreach ($user as $users)
                                                <option value="{{ $users->firstname . ' ' . $users->lastname }}"></option>
                                            @endforeach
                                        </datalist>
                            ...
                            <div class="chat-box p-4 overflow-auto">
                                @foreach ($pesan as $data_pesan)
                                    @if ($data_pesan->penerima == 'User')
                                        <div class="row mb-2">
                                            <div class="col-md-1">
                                                <img src="{{ asset('src/img/mail.png') }}" alt="" width="40">
                                            </div>
                                            <div class="col">
                                    ...
                                    @if ($data_pesan->penerima == 'Admin')
                                        <div class="row">
                                            <div class="col text-end">
                                                <h6 class="fw-bold">{{ auth()->user()->firstname.' '.auth()->user()->lastname }}</h6>
                                    ...
                                    <div class="row text-center">
                                        <div class="col-md-8 row">
                                            <div class="col round mx-2 border p-1 tombol">
                                                <img src="{{ asset('src/img/photo.png') }}" alt="" width="25"><i
                                                    class="text-sm fst-normal"> Photo</i>
                                            </div>
                                            <div class="col round mx-2 border p-1 tombol">
                                                <img src="{{ asset('src/img/video.png') }}" alt="" width="25"><i
                                                    class="text-sm fst-normal"> Video</i>
                                            </div>
                                            <div class="col round mx-2 border p-1 tombol">
                                                <img src="{{ asset('src/img/emoji.png') }}" alt="" width="25"><i
                                                    class="text-sm fst-normal"> Emoticons</i>
                                            </div>
                                        </div>
                                        <div class="col text-end">
                                            <button type="submit" class="btn btn-primary px-5 round"><i
                                                    class="bi bi-send"></i><i class="text-sm fst-normal">Send</i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
